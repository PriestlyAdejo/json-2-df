"""
Before coding the main app I am going to use the example file structure of the main
json file I made and make modifications for differentusecases.

# Json structure
data_sv = {'top_level_name': {'link': l_link}}
"""
import re
import json
import fitz
...
def _json_normalize(
    ...
    record_path: str or list or None = None,\
    meta: str or list[str or list[str]] or None = None,
    meta_prefix: str or None = None,
    record_prefix: str or None = None,
    errors: str = "raise",
    sep: str = ".",
    max_level: int or None = None) -> DataFrame:
    """
